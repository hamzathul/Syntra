...
export function createTaxesRouter(controller: TaxesController): Router {
  ...
  router.patch("/rates/:id", validateRequest({ params: paramsWithId, body: updateTaxRateSchema }), controller.updateRate);
  router.delete("/rates/:id", validateRequest({ params: paramsWithId }), controller.deleteRate);
  ...
  router.patch("/groups/:id", validateRequest({ params: paramsWithId, body: updateTaxGroupSchema }), controller.updateGroup);
  router.delete("/groups/:id", validateRequest({ params: paramsWithId }), controller.deleteGroup);
